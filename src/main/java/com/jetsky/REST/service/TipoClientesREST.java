...
import com.jetsky.jpa.sessions.TipoClientesFacade;
...
public class TipoClientesREST {

   
    @EJB
    private TipoClientesFacade tipoClientesEJB;
   ...
   // @RolesAllowed({"ADMIN"})
    public List<TipoClientes> findAll() {
        return tipoClientesEJB.findAll();
    }
    
    @POST
    public Response create(TipoClientes tipoClientes) {
        GsonBuilder gsonBuilder = new GsonBuilder();
        Gson gson = gsonBuilder.create();
        try{
            tipoClientesEJB.create(tipoClientes);
    ...
    @GET
    @Path("{id}")
    public TipoClientes findById(@PathParam("id") Integer id) {
        return tipoClientesEJB.find(id);
    }
    
    @PUT
    @Path("{id}")
    public void edit(@PathParam("id") Integer id, TipoClientes tipoClientes){
        tipoClientesEJB.edit(tipoClientes);
    }
